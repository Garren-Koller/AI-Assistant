...
IFontDisp = Font
__all__ = [ 'StdFont', 'IFontDisp', 'OLE_OPTEXCLUSIVE',
           'OLE_YSIZE_CONTAINER', 'OLE_YSIZE_HIMETRIC', 'OLE_HANDLE',
           'IFontEventsDisp', 'OLE_YSIZE_PIXELS', 'Gray',
           'OLE_XSIZE_HIMETRIC', 'FONTNAME', 'OLE_COLOR',
           'FONTUNDERSCORE', 'VgaColor', 'FONTSIZE', 'OLE_TRISTATE',
           'IFont', 'Default', 'OLE_XPOS_CONTAINER', 'Monochrome',
           'Color', 'OLE_YPOS_HIMETRIC', 'FontEvents', 'Checked',
           'StdPicture', 'OLE_XSIZE_CONTAINER', 'IPicture',
           'FONTITALIC', 'OLE_XPOS_HIMETRIC', 'FONTSTRIKETHROUGH',
           'OLE_ENABLEDEFAULTBOOL', 'Picture', 'Font', 'IPictureDisp',
           'Unchecked', 'OLE_YPOS_CONTAINER', 'LoadPictureConstants',
           'OLE_YPOS_PIXELS', 'OLE_CANCELBOOL', 'OLE_XSIZE_PIXELS',
           'OLE_XPOS_PIXELS', 'FONTBOLD']
